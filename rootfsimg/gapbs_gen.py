...
mybench_info = {
  "gap_bc": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/bc",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_bfs": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/bfs",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_cc": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/cc",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_pr": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/pr",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_sssp": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/sssp",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_tc": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/tc",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_cc_sv": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/cc_sv",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
  "gap_pr_spmv": (
    [
      "/nfs/home/zhangchuanqi/lvna/benchmarks/gapbs/pr_spmv",
    ],
    [ "-g 20 -n 10" ],
    []
  ),
...
if __name__ == "__main__":
  ...
  for gap in all_gaps:
    tmp_gap = [gap]
    generate_initramfs(tmp_gap)
    generate_run_sh(tmp_gap, True)
    os.system("make -j 16 -C /nfs/home/zhangchuanqi/lvna/for_xs/xs-env/sw/riscv-pk")
    os.makedirs(f"/nfs/home/zhangchuanqi/lvna/for_xs/xs-env/sw/riscv-pk/out_bins/gapbs", exist_ok=True)
    shutil.copy("/nfs/home/zhangchuanqi/lvna/for_xs/xs-env/sw/riscv-pk/build/bbl.bin",
                 f"/nfs/home/zhangchuanqi/lvna/for_xs/xs-env/sw/riscv-pk/out_bins/gapbs/{gap}.bin")
