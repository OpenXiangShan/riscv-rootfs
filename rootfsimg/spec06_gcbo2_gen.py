...
spec_info = {
  "astar_biglakes": (
    [
      "${SPEC}/spec06_exe/astar_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "bwaves": (
    [
      "${SPEC}/spec06_exe/bwaves_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "bzip2_chicken": (
    [
      "${SPEC}/spec06_exe/bzip2_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "cactusADM": (
    [
      "${SPEC}/spec06_exe/cactusADM_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "calculix": (
    [
      "${SPEC}/spec06_exe/calculix_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "dealII": (
    [
      "${SPEC}/spec06_exe/dealII_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "gamess_cytosine": (
    [
      "${SPEC}/spec06_exe/gamess_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "gcc_166": (
    [
      "${SPEC}/spec06_exe/gcc_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "GemsFDTD": (
    [
      "${SPEC}/spec06_exe/GemsFDTD_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "gromacs": (
    [
      "${SPEC}/spec06_exe/gromacs_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "h264ref_foreman.baseline": (
    [
      "${SPEC}/spec06_exe/h264ref_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "hmmer_nph3": (
    [
      "${SPEC}/spec06_exe/hmmer_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "lbm": (
    [
      "${SPEC}/spec06_exe/lbm_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "leslie3d": (
    [
      "${SPEC}/spec06_exe/leslie3d_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "libquantum": (
    [
      "${SPEC}/spec06_exe/libquantum_base.riscv64-unknown-linux-gnu-gcc-10.2.0"
    ],
    [ "1397", "8" ],
    [ "ref.out" ]
  ),
  "mcf": (
    [
      "${SPEC}/spec06_exe/mcf_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "milc": (
    [
      "${SPEC}/spec06_exe/milc_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "namd": (
    [
      "${SPEC}/spec06_exe/namd_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "omnetpp": (
    [
      "${SPEC}/spec06_exe/omnetpp_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "perlbench_checkspam": (
    [
      "${SPEC}/spec06_exe/perlbench_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "sjeng": (
    [
      "${SPEC}/spec06_exe/sjeng_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "soplex_pds-50": (
    [
      "${SPEC}/spec06_exe/soplex_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "tonto": (
    [
      "${SPEC}/spec06_exe/tonto_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
  ...
  "zeusmp": (
    [
      "${SPEC}/spec06_exe/zeusmp_base.riscv64-unknown-linux-gnu-gcc-10.2.0",
...
if __name__ == "__main__":
  os.environ['SPEC'] = '/nfs/home/share/xs-workloads/spec/spec-all'
  all_specs = list(spec_info.keys())
  for s in all_specs:
    specs = [s]
    ...
    os.makedirs(f"/nfs/home/share/zhangchuanqi/cpt_bins/spec06-gcb-o2", exist_ok=True)
    shutil.copy("/nfs/home/zhangchuanqi/lvna/for_xs/xs-env/sw/riscv-pk/build/bbl.bin",
                 f"/nfs/home/share/zhangchuanqi/cpt_bins/spec06-gcb-o2/{s}.bin")
